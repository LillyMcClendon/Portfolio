...
study1results$Maintenance_Task_Domain <- (factor(study1results$Maintenance_Task_Domain, levels = c("Perception Maintenance", "Feeling Maintenance")))

plot<- ggplot(study1results, aes(x = reorder(Task_Interaction, Latent_Maintenance), 
...
plot + geom_signif(comparisons = list (c("Perception Maintenance", "Feeling Maintenance")), map_signif_level = TRUE)
